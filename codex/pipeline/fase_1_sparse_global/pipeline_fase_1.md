...
| 1M | `actual/a probar en simulación` | `CovisibilityDatabase` implementada. | Raw DB con covisibilidad ORB-SLAM3 y loops geométricos futuros. | Base consultable por detector/optimizador, con pose relativa medida/current. | No guardar candidatos: solo relaciones confirmadas; validar antes de iniciar 1N. |
